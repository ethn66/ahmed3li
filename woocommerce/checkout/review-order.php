...
$sub_total_class = 'product-subtotal font-' . get_theme_mod( 'typo_price', 1 );
?>
<table class="shop_table woocommerce-checkout-review-order-table">
				...
				<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<td class="product-data" data-title="<?php esc_attr_e( 'Product', 'zeen' ); ?>">
						<div class="tipi-flex tipi-flex-wrap tipi-vertical-c">
							...
							<div class="<?php echo esc_attr( $sub_total_class ); ?>">
								<?php
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			<th><?php esc_html_e( 'Subtotal', 'zeen' ); ?></th>
		...
		<tr class="order-total">
			<th><?php esc_html_e( 'Total', 'zeen' ); ?></th>
